...
/// list, then leave the chat and verify removal. Drives the concrete mobile
/// robots directly since it never runs cross-platform.
class ChatDmLeaveScenario extends BaseTestScenario {
  ChatDmLeaveScenario(super.$, super.robots);
  ...
  Future<void> runTestLogic() async {
    ...
    final now = DateTime.now();
    final testMessage = 'Test message ${now.hour}:${now.minute}:${now.second}';
