...
void main() {
  ...
  TestBase().runPatrolTest(
    ...
    test: ($) async {
      ...
      s.softAssertEquals(group.root.exists, true, "the new group $groupName is not listed");
      s.verifyAll();
    },
  );
  ...
  TestBase().runPatrolTest(
    ...
    test: ($) async {
      ...
      s.softAssertEquals(GroupInformationRobot($).getEditGroupIcon().exists, true, 'Edit btn is mising',);
