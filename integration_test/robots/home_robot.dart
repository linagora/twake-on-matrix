...
class HomeRobot extends CoreRobot {
  ...
  Future<void> confirmAccessContact() async {
    try {
      await $.native.waitUntilVisible(Selector(textContains: 'OK'), appId:'com.apple.springboard',);
      await $.native.tap(Selector(textContains: 'OK'), appId:'com.apple.springboard',);
    } catch (e) {
      ignoreException();
    }
  }
