...
class SaveRecoveryWordsInteractor {
  final RecoveryWordsRepository recoveryWordsRepository = getIt.get<RecoveryWordsRepository>();

  Future<Either<SaveRecoveryWordsFailed, SaveRecoveryWordsSuccess>> execute(String words) async {
    try {
      final bool response = await recoveryWordsRepository.saveRecoveryWords(words);
      return response
