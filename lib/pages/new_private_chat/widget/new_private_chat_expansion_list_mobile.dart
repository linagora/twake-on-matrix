...
class NewPrivateChatExpansionListMobile extends StatelessWidget {
  ...
  List<Widget> _buildNewChatButtons(BuildContext context) {
    ...
    return [
      ...
      _NewEncryptedDirectChatButton(
        onPressed: goToNewEncryptedChat,
      ),
    ];
  }
}
...
class _NewEncryptedDirectChatButton extends StatelessWidget {
  final Function() onPressed;

  const _NewEncryptedDirectChatButton({
    Key? key,
    required this.onPressed,
  }) : super(key: key);
          ...
          child: SizedBox(
            ...
            child: Row(
              children: [
                ...
                Text(
                  L10n.of(context)!.newEncryptedDirectChat,
                  style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                        color: Theme.of(context).colorScheme.primary,
                        letterSpacing: -0.15,
                      ),
