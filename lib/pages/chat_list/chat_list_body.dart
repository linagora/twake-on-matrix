              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int i) {
                    ...
                    controller.chatListIndexes[rooms[i].id] = i;
                    return ChatListItem(
                      rooms[i],
                  ...
                  findChildIndexCallback: (key) {
                    ...
                    final roomId = valueKey.value.replaceFirst('chat_list_item_', '');
                    return controller.chatListIndexes[roomId];
                  },
                ),
              ),
            ],
