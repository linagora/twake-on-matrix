...
import 'package:twake_chat/pages/bootstrap/recovery_key_form_view.dart';
import 'package:twake_chat/pages/bootstrap/reset_encryption_confirm_view.dart';
...
import 'package:twake_chat/pages/bootstrap/verify_device_view.dart';
    ...
    switch (request.state) {
      ...
      case KeyVerificationState.error:
        return KeyVerificationErrorView(
          ...
          onClose: notifier.dismissSasRequest,
        );
