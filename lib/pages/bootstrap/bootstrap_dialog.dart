...
import 'package:twake_chat/domain/keychain_sharing/tom_encryption_reset_service.dart';
...
import 'package:twake_chat/widgets/adaptive_flat_button.dart';
...
class BootstrapDialogState extends State<BootstrapDialog> {
  ...
  Future<void> _createBootstrap(
    ...
    String? key;
    try {
      key = await const FlutterSecureStorage().read(key: _secureStorageKey);
    } catch (e, s) {
      Logs().w(
        'BootstrapDialog::_createBootstrap(): secure storage read failed',
        e,
        s,
      );
    }
