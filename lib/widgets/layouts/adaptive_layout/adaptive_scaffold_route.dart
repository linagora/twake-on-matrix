...
class AdaptiveScaffoldRoute extends StatelessWidget {
  ...
  static const scaffoldWithNestedNavigationKey = ValueKey('ScaffoldWithNestedNavigation');
      ...
      child: AdaptiveLayout(
        ...
        body: SlotLayout(
          config: <Breakpoint, SlotLayoutConfig>{
            const WidthPlatformBreakpoint(end: ResponsiveUtils.maxMobileWidth): SlotLayout.from(
              key: breakpointMobileKey,
              builder: (_) => secondaryBody != null ? _secondaryBodyWidget(context, isWebAndDesktop: false) : _bodyWidget(isWebAndDesktop: false),
            ),
            const WidthPlatformBreakpoint(begin: ResponsiveUtils.minTabletWidth): SlotLayout.from(
  ...
  Widget _secondaryBodyWidget(BuildContext context, {bool isWebAndDesktop = true}) {
    return Padding(
