...
void main() {
  ...
  group('Can edit event with room not encrypted test', () {
    ...
    test(
      ...
      () {
        final event = Event(
          content: {"body": "Nhiều thế", "msgtype": "m.text"},
          type: 'm.room.message',
  ...
  group('Can edit event with room  encrypted test', () {
    late Client client;
    ...
    test('Room is encrypted and event is decrypted then can edit is true', () {
      final event = Event(
  ...
  group('LocalizedBody.isSameEvent', () {
    ...
    test('should return true when transaction IDs match', () {
      final event1 = createEvent(eventId: '\$event1', transactionId: 'txn123');
      final event2 = createEvent(eventId: '\$event2', transactionId: 'txn123');
  ...
  group('isMention test', () {
    ...
    test('returns false when formatted_body is not present', () {
      final event = createEvent(
        content: {'body': 'Message to @admin:fakeServer', 'msgtype': 'm.text'},
      );
    ...
    test('returns false when body is empty and no formatted_body', () {
      final event = createEvent(content: {'body': '', 'msgtype': 'm.text'});
  ...
  group('isCaptionModeOrReply test', () {
    ...
    test('GIVEN image event with empty body\n'
        'THEN return false\n', () {
      final event = createEvent(
        content: {
          'body': '',
    ...
    test('GIVEN image event with body same as filename\n'
        'THEN return false\n', () {
      final event = createEvent(
        content: {
          'body': 'image.jpg',
    ...
    test('GIVEN image event with body different from filename\n'
        'THEN return true\n', () {
      final event = createEvent(
        content: {
    ...
    test('GIVEN video event with body different from filename\n'
        'THEN return true\n', () {
      final event = createEvent(
        content: {
          'body': 'Birthday party',
    ...
    test('GIVEN file event with body different from filename\n'
        'THEN return true\n', () {
      final event = createEvent(
        content: {
    ...
    test('GIVEN text event that is a reply\n'
        'THEN return true\n', () {
      final event = createEvent(
        content: {
    ...
    test('GIVEN image event that is a reply\n'
        'THEN return true\n', () {
      final event = createEvent(
        content: {
          'body': 'image.jpg',
    ...
    test('GIVEN text event with no caption or reply\n'
        'THEN return false\n', () {
      final event = createEvent(
        content: {'body': 'Just a regular message', 'msgtype': 'm.text'},
      );
  ...
  group('isReplyEventWithAudio test', () {
    ...
    test('GIVEN audio event that is a reply\n'
        'THEN return true\n', () {
      final event = createEvent(
        content: {
          'body': 'audio.mp3',
    ...
    test('GIVEN audio event that is NOT a reply\n'
        'THEN return false\n', () {
      final event = createEvent(
        content: {
          'body': 'audio.mp3',
    ...
    test('GIVEN video event that is a reply\n'
        'THEN return false\n', () {
      final event = createEvent(
        content: {
          'body': 'video.mp4',
    ...
    test('GIVEN file event that is a reply\n'
        'THEN return false\n', () {
      final event = createEvent(
        content: {
          'body': 'document.pdf',
