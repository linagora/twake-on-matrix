...
void main() {
  group(
    'Room extension and canUpdateRoleInRoom test',
    () {
      late Client client;
      ...
      test(
        'Given @alice:matrix.org is admin'
      ...
      test(
        'Given @alice:matrix.org is Moderator'
      ...
      test(
        'Given @alice:matrix.org is Member'
        'THEN canUpdateRoleInRoom return false',
        () {
          room.setState(
            Event(
      ...
      test(
        'Given @alice:matrix.org is Guest'
        'THEN canUpdateRoleInRoom return false',
        () {
          room.setState(
            Event(
