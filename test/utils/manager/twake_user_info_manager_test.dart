...
void main() {
  ...
  setUp(() {
    ...
    if (!getIt.isRegistered<UserInfoRepository>()) {
      getIt.registerSingleton<UserInfoRepository>(mockUserInfoRepository);
    }
  });
  ...
  group('TwakeUserInfoManager', () {
    ...
    test('should handle null avatarUrl in Matrix profile', () async {
      // Arrange
