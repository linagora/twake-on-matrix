...
void main() {
  group('MatrixDioCacheInterceptor - addUriSupportsCache', () {
    ...
    test(
      'WHEN adding multiple unique URIs '
    ...
    test(
      'WHEN adding duplicate URIs in the same call '
    ...
    test(
      'WHEN adding a URI that was previously added '
    ...
    test(
      'WHEN adding an empty list of URIs '
    ...
    test(
      'WHEN adding URIs with different paths from same domain '
    ...
    test(
      'WHEN adding URIs from different domains '
      'THEN all URIs should be added successfully',
      () {
        // Arrange
        const uri1 =
    ...
    test(
      'WHEN adding URIs with special characters '
    ...
    test(
      'WHEN adding URIs incrementally across multiple calls '
    ...
    test(
      'WHEN adding a mix of new and existing URIs '
      ...
      () {
        ...
        interceptor.addUriSupportsCache(
          [existingUri1, newUri1, existingUri2, newUri2],
        );
    ...
    test(
      'WHEN adding URIs with different protocols '
      'THEN all URIs should be added successfully',
      () {
        // Arrange
    ...
    test(
      'WHEN adding URIs with trailing slashes vs without '
      'THEN both should be treated as unique URIs',
      () {
        // Arrange
        const uriWithSlash = 'https://matrix.example.com/_twake/v1/user_info/';
        const uriWithoutSlash =
            'https://matrix.example.com/_twake/v1/user_info';
    ...
    test(
      'WHEN adding URIs with query parameters '
    ...
    test(
      'WHEN adding a large number of URIs '
      'THEN all URIs should be added successfully',
      () {
        // Arrange
