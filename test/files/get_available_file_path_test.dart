...
void main() async {
  ...
  test(
    """WHEN exist only one file in the folder,
          THEN the function should create another file with format fileName (1)
      """,
    () async {
      final file = await createMockFile('file1.pdf');
      final fileAvailable = await StorageDirectoryManager.instance
          .getAvailableFilePath(file.path);
      await file.delete();
  ...
  test(
    """WHEN exist only two files in the folder,
    ...
    () async {
      ...
      await Future.wait([file.delete(), file1.delete()]);
  ...
  test(
    """WHEN exist a file with name already have counter in the folder,
  ...
  test(
    """WHEN exist a file that contains dot,
          THEN the function should create another file with format fileName (1)
      """,
    () async {
  ...
  test(
    """WHEN exist a file that contains no dot,
          THEN the function should create another file with format fileName (1)
      """,
    () async {
  ...
  test(
    """WHEN exist a file that start with a dot,
          THEN the function should create another file with format fileName (1)
      """,
    () async {
  ...
  test(
    """WHEN exist a file that have extension contains multiple dots,
          THEN the function should create another file with format fileName (1)
      """,
    () async {
  ...
  test(
    ...
    () async {
      ...
      await Future.wait([file.delete(), file1.delete(), file3.delete()]);
